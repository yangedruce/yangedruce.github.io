<template>
	<section
		id="one"
		class="yangEdruce relative border border-brandNeutral-800 dark:border-brandPrimaryWhite bg-brandNeutral-50 dark:bg-brandPrimaryBlack m-4 xl:m-8 rounded-2xl h-[70vh] md:h-[45vh] xl:h-[93.4vh]">
