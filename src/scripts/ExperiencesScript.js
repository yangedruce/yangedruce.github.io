...
const bulletPointsAchievementsWebDeveloper = [
	...
	"Proactively conducted rigorous testing of different websites of the company's clients and potential clients, focusing on improving UIUX design and SEO based on the HTML coding standards. Managed to secure extensive contracts for maintaining existing clients' websites like Yoodo, Big Bad Wolf, and Rohto (Sunplay and Lipcare), and attracted new ones like RedOne, Celcom, and CelcomDigi.",
